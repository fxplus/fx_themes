...
function student_plus_menu_link($variables) {
  if ($variables['element']['#original_link']['menu_name'] == 'menu-home-actions') {
    $element = $variables['element'];
    $output = l($element['#title'], $element['#href'], _student_plus_button_attributes($variables['element']['#original_link']));
    return $output."\n";
...
function _student_plus_button_attributes($menu_link = FALSE) {
  if (!$menu_link) {
